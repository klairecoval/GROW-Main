...
const handleSignup = (e) => {
    ...
    if(document.getElementById('userCodeVal').innerText !== $('#user').val()) {4
...
const SignupWindow = (props) => {
    return (
        <form id='signupForm' name='signupForm'
            ...
            method='POST'
            className='mainForm'>
            <input id='user' className="lato" type='text' maxLength="4" name='username' placeholder='Paste code here' />
